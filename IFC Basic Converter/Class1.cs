...
namespace IFC_Basic_Converter
{
    ...
    {       //class is designed to find the property values of each element in the IFC file and returns all of them in a string array, ending each with new line (ignore the backslashes since they are not recognized)
        ...
        public static string[] findEntity(string schemaPath, string start)      //finds the properties of the elements and makes a string array of a single element, starting with the object reference and entity name
        {
        ...
        public static void findSubProps(string schemaPath, string start, List<string> current, int level)       //additional method after the first entity is found
        {
